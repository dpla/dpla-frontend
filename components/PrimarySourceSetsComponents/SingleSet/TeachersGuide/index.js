          ...
          <div className={utils.row}>
              ...
              <div className={css.content}>
                ...
                <div className={css.aboutThis}>
                  ...
                  <div>
                    ...
                    , in the classroom. It offers discussion questions,
                    classroom activities, and primary source analysis tools. It
                    is intended to spark pedagogical creativity by giving a
                    sample approach to the material. Please feel free to share,
                    reuse, and adapt the resources in this guide for your
                    teaching purposes.
                  </div>
                </div>
              </div>
            ...
            <div className={`${utils.colXs12} ${utils.colMd4} ${css.sidebar}`}>
              <div className={`${css.teacherTools} ${css.sidebarSection}`}>
                ...
                {isPrintable !== true && this.state.routePath && (
              ...
              <div className={css.sidebarSection}>
                <h3 className={css.sidebarHeader}>Primary source analysis</h3>
