    ...
    .iterate((value, key) => {
      if (value.name) {
        lists.push({
          uuid: key,
          name: value.name,
          count: value?.selectedHash ? Object.keys(value.selectedHash).length : 0,
