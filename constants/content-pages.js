...
export const NEWS_ENDPOINT = `${WORDPRESS_URL}/wp-json/wp/v2/news`;
export const BLOGS_ENDPOINT = `${WORDPRESS_URL}/wp-json/wp/v2/posts`;
export const BLOGS_HOME_ENDPOINT = `${BLOGS_ENDPOINT}?per_page=3`;
