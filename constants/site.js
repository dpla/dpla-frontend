...
export const rightsURLs = {
  ...
  "http://rightsstatements.org/vocab/CNE/1.0/": {
    description: "This Rights Statement should be used for Items for which the copyright status is unknown and for which the data provider has not undertaken an effort to determine the copyright status of the work.",
    image: ""
  },
