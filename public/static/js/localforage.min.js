  ...
  if ("object" == typeof exports && "undefined" != typeof module)
    ...
    (b = "undefined" != typeof window
      ...
      : "undefined" != typeof global
        ? global
        : "undefined" != typeof self ? self : this), (b.localforage = a());
  }
})(function() {
  ...
  })(
    {
              ...
              e = "document" in a &&
                ...
                ? function() {
                    ...
                    (b.onreadystatechange = function() {
                      c(), (b.onreadystatechange = null), b.parentNode.removeChild(
                        b
                      ), (b = null);
      ...
      2: [
        function(a, b, c) {
          ...
          function e(a) {
            ...
            (this.state = s), (this.queue = []), (this.outcome = void 0), a !==
              d && i(this, a);
          }
          function f(a, b, c) {
            (this.promise = a), "function" == typeof b &&
              (
                (this.onFulfilled = b),
      ...
      4: [
        function(a, b, c) {
          ...
          function i(a, b, c) {
            "function" == typeof b && a.then(b), "function" == typeof c &&
              a.catch(c);
          }
          function j(a) {
          ...
          function o(a) {
            ...
            })), b.deferredOperations.push(c), b.dbReady
            ...
            return new va(function(c, d) {
              ...
              b &&
                (f.onupgradeneeded = function(b) {
                  var c = f.result;
                  try {
                    c.createObjectStore(a.storeName), b.oldVersion <= 1 &&
          ...
          function C(a) {
            ...
            var f = ya[d.name];
            f || ((f = B()), (ya[d.name] = f)), f.forages.push(
              c
          ...
          function F(a, b, c) {
            ...
            var e = new va(function(c, e) {
              ...
              d
                .ready()
                .then(function() {
                  return (f = d._dbInfo), "[object Blob]" === za.call(b)
          ...
          function N(a) {
            ...
            var j = new ArrayBuffer(g),
              k = new Uint8Array(j);
            for (b = 0; b < h; b += 4)
              (c = Da.indexOf(a[b])), (d = Da.indexOf(
                a[b + 1]
              )), (e = Da.indexOf(a[b + 2])), (f = Da.indexOf(a[b + 3])), (k[
                i++
              ] =
                (c << 2) | (d >> 4)), (k[i++] = ((15 & d) << 4) | (e >> 2)), (k[
                i++
              ] =
                ((3 & e) << 6) | (63 & f));
            return j;
          ...
          function O(a) {
            ...
            for (b = 0; b < c.length; b += 3)
              (d += Da[c[b] >> 2]), (d +=
                Da[((3 & c[b]) << 4) | (c[b + 1] >> 4)]), (d +=
                Da[((15 & c[b + 1]) << 2) | (c[b + 2] >> 6)]), (d +=
                Da[63 & c[b + 2]]);
            return c.length % 3 == 2
          ...
          function fa() {
            ...
            try {
              return localStorage.setItem(a, !0), localStorage.removeItem(
                a
              ), !1;
            } catch (a) {
              return !0;
          ...
          function ha(a) {
            ...
            return (c.keyPrefix = ea(a, b._defaultConfig)), ga()
          ...
          function qa(a, b) {
            if (
              ...
              var c = this.config();
              (a.name = a.name || c.name), (a.storeName =
                a.storeName || c.storeName);
            }
            var d,
              e = this;
            return (d = a.name
          ...
          var va = Promise,
            ...
            gb = (function() {
              function a(b) {
                ...
                (this._defaultConfig = sa({}, fb)), (this._config = sa(
                  {},
                  this._defaultConfig,
                  b
                )), (this._driverSet = null), (this._initDriver = null), (this._ready = !1), (this._dbInfo = null), this._wrapLibraryMethodsWithReady(), this.setDriver(
                  this._config.driver
                ).catch(function() {});
              }
              return (a.prototype.config = function(a) {
                ...
                var b = this,
                  c = b._driverSet.then(function() {
                    return null === b._ready &&
                      (b._ready = b._initDriver()), b._ready;
                  });
                return i(c, a, a), c;
                ...
                function e(a) {
                  return g._extend(a), d(), (g._ready = g._initStorage(
                    g._config
                  )), g._ready;
                }
                function f(a) {
                  return function() {
                    function b() {
                      for (; c < a.length; ) {
                        var f = a[c];
                        return c++, (g._dbInfo = null), (g._ready = null), g
                          .getDriver(f)
                          .then(e)
                          .catch(b);
                      }
                ...
                return (this._driverSet = j
                  .then(function() {
                    ...
                    return (g._dbInfo = null), (g._ready = null), g.getDriver(a).then(function(a) {
                      (g._driver =
                        a._driver), d(), g._wrapLibraryMethodsWithReady(), (g._initDriver = f(h));
                    });
                  })
                  .catch(function() {
                    d();
